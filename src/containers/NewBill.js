...
export default class NewBill {
  ...
  handleChangeFile = e => {
    ...
    this.store
      ...
      .then(({fileUrl, key}) => {
        console.log("File URL:", fileUrl);  // Vérifie l'URL de l'image
        this.billId = key
        this.fileUrl = fileUrl // URL de l'image
        this.fileName = fileName // Nom du fichier
  ...
  handleSubmit = e => {
    ...
    const bill = {
      ...
      fileUrl: this.fileUrl, // URL de l'image
